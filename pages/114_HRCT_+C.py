...
st.title("🩻 HRCT with contrast Report by Bright")
...
with col1:
    ...
    title = st.selectbox("Title", options["titleHRCT"])
    history = st.text_area("History", "Case of xx; follow-up.")
    techniques = st.text_area("Techniques", "\n- Non-enhanced axial CT scan of the chest was performed, with a scan collimation of 0.625 mm. The axial images were reconstructed with a slice thickness of 1 mm at 0.7-mm scans interval. \n- Forced dynamic expiratory CT scan of the chest was done with a slice thickness of 1 mm at 0.7-mm scans interval. \n- Prone inspiratory HRCT scans of the lungs were done, using a slice thickness of 1 mm at 10-mm scan intervals. \n- Contrast-enhanced MDCT scan of the chest was done with a slice thickness of 2 mm.")
    ...
    st.subheader("Lung parenchyma and central airways")
    sub_hrct = st.selectbox("Title", options["sub_hrct"], label_visibility="collapsed")
    ...
    hrct_exp1 = smart_selectbox("Expiratory scan", options["hrct_exp1"])
    hrct_exp2 = smart_selectbox("Expiratory scan", options["hrct_exp2"], label_visibility="collapsed")   
    cent_air = st.text_input("Central airways", "Patent trachea and both main bronchi.")
...
with col2:
    ...
    report_text = f"{title}AND MDCT OF THE CHEST \n\n"
    ...
    report_text += f"- {hrct_exp1}{hrct_exp2}\n"
    report_text += f"- {cent_air}\n"
