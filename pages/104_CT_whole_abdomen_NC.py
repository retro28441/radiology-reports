...
st.title("🩻 CT WHOLE Abdomen (NON-CONTRAST) Report by Bright")
...
with col1:
    ...
    history = st.text_area("History", "Case of .., presented with .. for ... The laboratory shows ... This CT was requested to rule out ...")
    ...
    mass_duct = st.text_input("Mass&Duct", "No Abnormal calcification.")
    ...
    kidneys_status = st.text_input("Size", "Normal size of both kidneys.")
...
with col2:
    ...
    report_text = f"{title}OF THE WHOLE ABDOMEN (NON-CONTRAST)\n\n"
    ...
    report_text += build_line(sub_liver, liver_parenchyma, liver_no)
