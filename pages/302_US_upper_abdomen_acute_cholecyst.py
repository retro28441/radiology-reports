...
st.title("🩻 US UPPER Abdomen (Acute Cholecystitis) Report by Bright")
...
with col1:
    ...
    history = st.text_area("History", "Case of xx, presented with xx. The physical examination reveals RUQ tenderness. This study was sent to rule out acute cholecystitis.")
    ...
    gb_thick = st.text_area("Wall thikening/pericholecystic", "The gallbladder transverse diameter is $ cm. No gallbladder wall thickening or pericholecystic fluid.")
    sub_murphy = st.text_input("Title", "Sonographic Murphy sign", label_visibility="collapsed")
    gb_murphy = smart_selectbox("Sonographic Murphy sign", options["gb_murphy"], label_visibility="collapsed")
...
with col2:
    ...
    report_text = f"{title} OF THE UPPER ABDOMEN\n\n"
    ...
    report_text += build_line(sub_murphy, gb_murphy)
