...
st.title("🩻 CT CHEST Report by Bright")
...
with col1:
    ...
    techniques = st.text_area("Techniques", "Axial helical scan of the chest with 2.5-mm slice thickness with multiplanar reformations.")
...
with col2:
    ...
    report_text = f"{title}SCAN OF THE CHEST\n\n"
