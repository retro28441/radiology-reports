...
st.title("🩻 HRCT Report by Bright")
...
with col2:
    ...
    report_text = f"{title}OF THE LUNGS \n\n"
    report_text += f"HISTORY: {history}\n"
    report_text += f"TECHNIQUES: \n{techniques}\n"
